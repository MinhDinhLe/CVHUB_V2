          ...
          <div className="lg:col-span-9">
            ...
            <div className="bg-gradient-to-r from-emerald-800 to-green-500 rounded-2xl overflow-hidden relative">
              ...
              <div className="relative p-6 sm:p-8">
                ...
                <p className="text-green-50/90 text-sm sm:text-base max-w-2xl">
                  Xem lại danh sách những việc làm mà bạn đã Ứng tuyển. Xem ngay để không bỏ lỡ cơ hội nghề nghiệp dành cho bạn.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-4">
              <p className="text-gray-700">
                Danh sách <span className="font-medium">4</span> việc làm đã ứng tuyển
              </p>
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <div className="flex flex-wrap gap-6">
                  {[
                    { id: 'recent', label: 'Đã duyệt' },
                    { id: 'urgent', label: 'Đang chờ' },
                    { id: 'salary', label: 'Đã Hủy' }
                  ].map((filter) => (
